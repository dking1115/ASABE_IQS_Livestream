...
ws = simpleobsws.WebSocketClient(url = 'ws://192.168.1.226:4455', password = 'ZDT4dGz7WYcbM5EY', identification_parameters = parameters) # Every possible argument has been passed, but none are required. See lib code for defaults.
